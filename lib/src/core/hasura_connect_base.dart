...
class HasuraConnectBase implements HasuraConnect {
  ...
  void Function(HasuraError hasuraError) _onHasuraError;
        ...
        handleData: (data, sink) {
          if (data['type'] == 'data') {
            ...
            if ((data['payload'] as Map).containsKey('errors')) {
              _onHasuraError(HasuraError.fromJson(data['payload']['errors'][0]));
              sink.addError(HasuraError.fromJson(data['payload']['errors'][0]));
            } else {
              _onHasuraError(HasuraError.fromJson(data['payload']));
  ...
  Future _sendPost(Map jsonMap, [String hash]) async {
    ...
    try {
      ...
      if (json.containsKey('errors')) {
        _onHasuraError(HasuraError.fromJson(json['errors'][0]));
        throw HasuraError.fromJson(json['errors'][0]);
      }
      return json;
    } on SocketException catch (_) {
      _onHasuraError(HasuraError('connection error', null));
